...
public class AuditAspect {
    ...
    /**
     * Pointcut pour toutes les méthodes des services SAUF JournalService, UtilisateurService, AnneeExerciceService, InstructeurService, StaffService, ParentService, EnfantService, InscriptionService, ActiviteService et BudgetGlobalService
     */
    @Pointcut("execution(* com.explorateur.backend.service.*Service.*(..)) && !execution(* com.explorateur.backend.service.JournalService.*(..)) && !execution(* com.explorateur.backend.service.UtilisateurService.*(..)) && !execution(* com.explorateur.backend.service.AnneeExerciceService.*(..)) && !execution(* com.explorateur.backend.service.InstructeurService.*(..)) && !execution(* com.explorateur.backend.service.StaffService.*(..)) && !execution(* com.explorateur.backend.service.ParentService.*(..)) && !execution(* com.explorateur.backend.service.EnfantService.*(..)) && !execution(* com.explorateur.backend.service.InscriptionService.*(..)) && !execution(* com.explorateur.backend.service.ActiviteService.*(..)) && !execution(* com.explorateur.backend.service.BudgetGlobalService.*(..))")
