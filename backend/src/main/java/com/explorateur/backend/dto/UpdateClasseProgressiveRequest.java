...
/**
 * DTO de requête pour modifier une ClasseProgressive
 */
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Requête de modification de Classe Progressive (CP)")
public class UpdateClasseProgressiveRequest {
